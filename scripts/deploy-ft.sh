...
echo "${BYellow}Hex:" "${BGreen}0x$(printf '%s' "$USDC" | xxd -p -u)"
...
echo "${BYellow}Hex:" "${BGreen}0x$(printf '%s' "$USDC_GOERLI" | xxd -p -u)"
...
echo "${BYellow}Hex:" "${BGreen}0x$(printf '%s' "$USDC_FUJI" | xxd -p -u)"
...
echo "${BYellow}Hex:" "${BGreen}0x$(printf '%s' "$USDC_SOL" | xxd -p -u)"
...
echo "${BYellow}Hex:" "${BGreen}0x$(printf '%s' "$SOL" | xxd -p -u)"
...
echo "${BYellow}Hex:" "${BGreen}0x$(printf '%s' "$ETH_GOERLI" | xxd -p -u)"
...
echo "${BYellow}Hex:" "${BGreen}0x$(printf '%s' "$AVAX_FUJI" | xxd -p -u)"
